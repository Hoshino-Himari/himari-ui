...
// 移植自 GodUI <https://godui.design/docs/components/visualizations/gravity> — MIT License © LucasBassetti
// 保留原始實作（本元件不使用主題色 class，未做替換）。

import Matter from "matter-js";
import * as React from "react";

/**
 * 重力場：用 matter-js 跑真實剛體物理，任何 DOM 元素放進 MatterBody 就會掉落、
 * 碰撞、堆疊，還能用滑鼠抓起來甩。離開畫面或切到別的分頁會自動暫停。
 * @example
 * <Gravity className="h-96">
 *   <MatterBody x="30%" y="10%">
 *     <span className="rounded-full bg-amber-500 px-4 py-2">動效</span>
 *   </MatterBody>
 * </Gravity>
 */
