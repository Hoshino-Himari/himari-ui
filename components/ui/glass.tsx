...
// 移植自 CanvasUI <https://canvasui.dev/docs/components/glass> — MIT + Commons Clause © DavidHDev
// 保留原始實作，僅做自足化最小調整。

/**
 * 玻璃折射：一枚跟著游標移動的玻璃鏡片，即時折射底下的 HTML 內容，
 * 含色散、菲涅耳反射與可調的放大倍率。瀏覽器不支援 html-in-canvas 時只顯示鏡片光暈。
 * @example
 * <Glass className="h-72">
