...
// 移植自 MagicUI <https://magicui.design/docs/components/retro-grid> — MIT License © magicuidesign
// 保留原始實作，僅做自足化最小調整。
...
/**
 * 復古網格：WebGL 繪製的 80 年代透視網格地平線，會持續向前捲動；
 * 不支援 WebGL 時自動退回 CSS 3D 版本，並尊重 prefers-reduced-motion。
 * @example
