...
// 移植自 GodUI <https://godui.design/docs/components/overlays/dynamic-island> — MIT License © LucasBassetti
// 保留原始實作，僅做自足化最小調整。
...
/**
 * 動態島：模仿 iPhone 動態島的黑色膠囊，隨 size 預設值以彈簧動畫變形，內容交叉淡入。
 * @example
 * <DynamicIsland size="compact">🎵 播放中</DynamicIsland>
 */
