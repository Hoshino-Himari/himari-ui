...
// 移植自 CanvasUI <https://canvasui.dev/docs/components/frost> — MIT + Commons Clause © DavidHDev
// 保留原始實作，僅做自足化最小調整。
/**
 * 結霜效果：在內容表面覆上一層會折射光線的冰霜，游標劃過會融出透明痕跡並緩慢重新結凍。
 * 在支援 HTML-in-canvas 的瀏覽器會霜化實際內容；其他瀏覽器退回顯示霜面覆蓋層。
 * @example <Frost className="h-72"><div>內容</div></Frost>
 */
