...
// 移植自 GodUI <https://godui.design/docs/components/effects/particle-dissolve> — MIT License © LucasBassetti
// 保留原始實作，僅做自足化最小調整。
...
/**
 * 粒子溶解：把文字或圖片取樣成粒子，從四散狀態聚合成形（或反向散開、來回循環）。
 * @example <ParticleDissolve text="曦光" trigger="mount" />
 */
