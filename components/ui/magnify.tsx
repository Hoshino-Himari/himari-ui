...
// 移植自 CanvasUI <https://canvasui.dev/docs/components/magnify> — MIT + Commons Clause © DavidHDev
// 保留原始實作，僅做自足化最小調整。
/**
 * 放大鏡透鏡：跟著游標移動的 WebGL 放大鏡，附 HUD 十字準星、刻度與座標讀數，點擊會激起漣漪。
 * 在支援 HTML-in-canvas 的瀏覽器可放大實際內容；其他瀏覽器優雅退回顯示原始內容。
 * @example <Magnify className="h-72"><div>內容</div></Magnify>
 */
