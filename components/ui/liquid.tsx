...
// 移植自 CanvasUI <https://canvasui.dev/docs/components/liquid> — MIT + Commons Clause © DavidHDev
// 保留原始實作，僅做自足化最小調整。

/**
 * 液體模擬：游標拂過時以 WebGL 流體模擬在 HTML 內容上掀起波紋與色彩拖尾，
 * 內容保持可讀、可互動。瀏覽器不支援 html-in-canvas 時自動退回純 HTML。
 * @example
 * <Liquid className="h-72">
