...
// 移植自 MagicUI <https://magicui.design/docs/components/hyper-text> — MIT License © magicuidesign
// 保留原始實作，僅做自足化最小調整。
...
/**
 * 亂數翻牌文字：字元先以隨機字母快速翻動，再由左至右逐一定格成目標文字，滑鼠移入可重播。
 * @example <HyperText>HIMARI UI</HyperText>
 */
