...
// 移植自 CanvasUI <https://canvasui.dev/docs/components/decrypt-reveal> — MIT + Commons Clause © DavidHDev
// 保留原始實作，僅做自足化最小調整。
/**
 * 解密顯現：內容化為不斷跳動的密文字元，游標掃過的範圍即時「解密」還原成真實 UI。
 * 在支援 HTML-in-canvas 的瀏覽器呈現完整效果；其他瀏覽器優雅退回顯示原始內容。
 * @example <DecryptReveal className="h-72"><div>內容</div></DecryptReveal>
 */
