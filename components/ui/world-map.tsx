...
// 移植自 GodUI <https://godui.design/docs/components/visualizations/world-map> — MIT License © LucasBassetti
...
/**
 * 世界地圖：點陣世界地圖上畫出城市之間的弧線航線，光束沿著弧線一段段畫出來並循環，
 * 端點還有一圈擴散的漣漪。適合展示服務涵蓋範圍或全球節點。
 * @example
 * <WorldMap lineColor="#f59e0b" />
 */
...
> & {
  ...
  lineColor?: string;
  /** Color of the land dots. Any CSS color. */
  dotColor?: string;
  ...
  (
    {
      ...
      lineColor = "var(--primary, oklch(0.205 0 0))",
      dotColor = "color-mix(in oklch, var(--muted-foreground, oklch(0.556 0 0)) 40%, transparent)",
      loop = true,
      duration = 1.6,
      className,
      style,
