...
// 移植自 MagicUI <https://magicui.design/docs/components/warp-background> — MIT License © magicuidesign
// 保留原始實作，僅做自足化最小調整（內聯 cn、gridColor 改為具體預設色、加入 reduced-motion 支援）。
...
/**
 * 空間扭曲邊框：內容四周以 3D 透視網格包圍，隨機色相的光束沿著網格面向遠方飛行，
 * 營造穿越空間的科幻感。尊重 prefers-reduced-motion（停用光束動畫）。
 * @example
 * <WarpBackground>
 *   <div className="mx-auto max-w-sm text-center">內容</div>
 * </WarpBackground>
 */
...
export const WarpBackground: React.FC<WarpBackgroundProps> = ({
  ...
  beamDelayMin = 0,
  beamDuration = 3,
  gridColor = "rgba(163, 163, 163, 0.35)",
  ...props
}) => {
  ...
  return (
    <div
      className={cn(
        "relative rounded border border-neutral-300/60 p-20 dark:border-neutral-700/60",
        className
      )}
      {...props}
    >
