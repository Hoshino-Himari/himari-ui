...
// 移植自 GodUI <https://godui.design/docs/components/layout/card-swap> — MIT License © LucasBassetti
// 保留原始實作，僅做自足化最小調整。
...
/**
 * 卡片交換：一疊 3D 堆疊卡片自動輪播交換，滑鼠移動帶出視差傾斜，附前後切換按鈕。
 * @example
 * <CardSwap className="h-56 w-72">
 *   <div>卡片一</div>
 *   <div>卡片二</div>
 * </CardSwap>
 */
        ...
        {n > 1 ? (
          <div className="absolute -bottom-12 flex items-center gap-2">
            <button
              ...
              className="rounded-full border border-[var(--border,#3f3f46)] bg-[var(--card,#18181b)] px-3 py-1.5 text-sm text-[var(--foreground,#fafafa)] shadow-sm [transition:background_150ms] hover:bg-[var(--accent,#27272a)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--ring,#71717a)]"
            >
              ‹
            </button>
            <button
