...
// 移植自 GodUI <https://godui.design/docs/components/layout/holographic-card> — MIT License © LucasBassetti
// 保留原始實作，僅做自足化最小調整。
...
/**
 * 全息卡片：隨游標傾斜的 3D 卡片，表面帶彩虹箔光、閃粉與鏡面眩光，像實體全息收藏卡。
 * @example
...
const GLARE_LAYER =
  "pointer-events-none absolute inset-0 z-20 mix-blend-soft-light [background:radial-gradient(40%_40%_at_var(--holo-x)_var(--holo-y),rgba(255,255,255,0.55),transparent_72%)]";

// Premium edge: a crisp top light-line plus an inner vignette to seat the card.
const EDGE_LAYER =
  "pointer-events-none absolute inset-0 z-20 rounded-[inherit] [box-shadow:inset_0_1px_0_0_rgba(255,255,255,0.18),inset_0_0_36px_0_rgba(0,0,0,0.45)]";
