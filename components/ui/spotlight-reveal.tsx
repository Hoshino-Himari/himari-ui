...
// 移植自 GodUI <https://godui.design/docs/components/effects/spotlight-reveal> — MIT License © LucasBassetti
// 保留原始實作，未做語意色替換（本元件不使用主題色 class）。

import { useReducedMotion } from "framer-motion";
import * as React from "react";

/**
 * 聚光燈揭露：上下兩層內容疊在一起，游標所在的圓形範圍會把上層挖穿、露出底下那層；
 * 沒有游標時光圈會自己緩慢繞圈，點一下可以把光圈釘住。
 * @example
 * <SpotlightReveal reveal={<img src="/after.jpg" alt="" />} className="h-72">
    ...
    return (
      ...
      >
        ...
        <div
          ...
          style={
            reduce ? { opacity: 0.9 } : { WebkitMaskImage: maskImage, maskImage }
          }
        >
          {children}
        </div>
