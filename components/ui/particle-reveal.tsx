...
// 移植自 CanvasUI <https://canvasui.dev/docs/components/particle-reveal> — MIT + Commons Clause © DavidHDev
// 保留原始實作，僅做自足化最小調整。
/**
 * 粒子顯現：內容分解成飄散的粒子塵埃，游標移入的範圍才凝聚回清晰畫面。
 * 在支援 HTML-in-canvas 的瀏覽器呈現完整效果；其他瀏覽器優雅退回顯示原始內容。
 * @example <ParticleReveal className="h-72"><div>內容</div></ParticleReveal>
 */
