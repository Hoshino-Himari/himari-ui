...
// 移植自 GodUI <https://godui.design/docs/components/backgrounds/topographic-drift> — MIT License © LucasBassetti
// 保留原始實作，僅做自足化最小調整：色彩探針改用 var(--foreground, fallback) 取代 text-foreground class。

import * as React from "react";

/**
 * 等高線漂移：用 marching squares 畫出的地形等高線背景，整片高度場緩緩流動，
 * 像一張活著的地圖。放在 `relative` 容器的第一個子元素。
 * @example
 * <div className="relative h-96 overflow-hidden">
 *   <TopographicDrift color="#f59e0b" />
 * </div>
 */
export type TopographicDriftProps = React.HTMLAttributes<HTMLDivElement> & {
  ...
  speed?: number;
  /**
   * Contour color, any CSS color string. Defaults to the `--foreground`
