...
// 移植自 MagicUI <https://magicui.design/docs/components/spinning-text> — MIT License © magicuidesign
// 保留原始實作，僅做自足化最小調整。
...
/**
 * 環形旋轉文字：把文字逐字排成圓環並持續旋轉，半徑、速度、方向皆可調。
 * @example <SpinningText>HIMARI UI • 微互動 • </SpinningText>
 */
