...
// 移植自 CanvasUI <https://canvasui.dev/docs/components/vhs> — MIT + Commons Clause © DavidHDev
// 保留原始實作，僅做自足化最小調整。

/**
 * VHS 效果：把 HTML 內容渲染成老式錄影帶畫面，含磁帶波動、掃描線、雜訊、
 * 色彩溢散與底部磁頭切換雜訊。瀏覽器不支援 html-in-canvas 時自動退回純 HTML。
 * @example
 * <VHS className="h-72">
