...
// 移植自 CanvasUI <https://canvasui.dev/docs/components/glitch> — MIT + Commons Clause © DavidHDev
// 保留原始實作，僅做自足化最小調整。

/**
 * 故障藝術：對 HTML 內容週期性施加水平撕裂、RGB 分離、方塊損毀與雜訊的故障效果，
 * 內容在效果之間保持可讀。瀏覽器不支援 html-in-canvas 時自動退回純 HTML。
 * @example
 * <Glitch className="h-72">
 *   <div className="flex h-full items-center justify-center">內容</div>
 * </Glitch>
 */
