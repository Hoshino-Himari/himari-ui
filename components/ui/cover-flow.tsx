...
// 移植自 GodUI <https://godui.design/docs/components/layout/cover-flow> — MIT License © LucasBassetti
...
/**
 * 封面流：iTunes 風格的 3D 封面輪播，中央那張正面朝向使用者，兩側往內翻轉並帶地板倒影，
 * 可拖曳、點擊或用左右鍵切換。
 * @example
 * <CoverFlow defaultIndex={1}>
 *   <img src="/a.jpg" alt="" />
 *   <img src="/b.jpg" alt="" />
 * </CoverFlow>
 */
...
const SLIDE_FRAME =
  "size-full overflow-hidden rounded-2xl border border-[var(--border,oklch(0.922_0_0))] bg-[var(--card,oklch(1_0_0))]";
...
const CoverItem: React.FC<CoverItemProps> = ({
  ...
  return (
    <motion.div
      ...
      onTap={onSelect}
    >
      <div className={`${SLIDE_FRAME} shadow-2xl`}>{children}</div>
      {reflection && !reduce ? (
        <div
          aria-hidden
